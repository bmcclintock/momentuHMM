...
test_that("angleDist=NULL and zeroInflation=TRUE work",{
  ...
  inputs <- checkInputs(nbStates,dist,Par,NULL,zeroInflation,NULL,NULL,NULL,NULL,m$stateNames)
  DMinputs<-getDM(data,inputs$DM,dist,nbStates,inputs$p$parNames,inputs$p$bounds,Par,inputs$cons,inputs$workcons,zeroInflation)
