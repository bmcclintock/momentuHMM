...
test_that("Lengths of input and output are the same",{
  ...
  expect_equal(length(n2w(par,bounds,list(beta=beta),log(delta[-1]/delta[1]),nbStates,list(step=FALSE),NULL,m$conditions$cons,m$conditions$workcons,m$conditions$Bndind)),
