...
- List of example [publications](https://github.com/bmcclintock/momentuHMM/publications/publications.md) using the package
...
## References
McClintock, B.T., Michelot, T. (2018) [momentuHMM: R package for generalized hidden Markov models of animal movement](https://dx.doi.org/10.1111/2041-210X.12995). *Methods in Ecology and Evolution*, 9(6), 1518-1530.
