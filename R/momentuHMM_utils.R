...
n2wDM<-function(bounds,DM,par,cons,logitcons){
  ...
  if(length(ind1)) p[ind1] <- (tan(par[ind1]/2)-logitcons[ind1])^(1/cons[ind1])
  ...
  p[ind21]<-(log(par[ind21]-a[ind21])-logitcons[ind21])^(1/cons[ind21])
  p[ind22]<-(logit((par[ind22]-a[ind22])/(b[ind22]-a[ind22]))-logitcons[ind22])^(1/cons[ind22])
  p[ind23]<-(-log(-par[ind23]+b[ind23])-logitcons[ind23])^(1/cons[ind23])
