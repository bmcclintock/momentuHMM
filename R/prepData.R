...
#' then z values must be set using \code{\link[raster:getZ]{setZ}} and \code{data} must include column(s) of the corresponding z value(s) for each observation (e.g., 'time').
