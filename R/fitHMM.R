...
#' Rivest et al. (2016).  In this case, the link function for the mean angle is atan2(Z \eqn{\circ} sin(X)*B,1+Z \eqn{\circ} cos(X)*B), where X are the angle covariates (\code{cov}), Z the strength covariates (\code{strength}), and B the angle coefficients (see Rivest et al. 2016).
#' 
