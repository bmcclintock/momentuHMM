...
#' \code{\link{simData}} (or \code{\link{simHierData}}) or \code{\link{simObsData}} (or \code{\link{simObsHierData}}), then the true locations (\code{mux},\code{muy}) are also plotted.
#' 
