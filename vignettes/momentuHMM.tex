...
\subsubsection{Atlantic cod example}
...
\begin{alltt}
\hlcom{# data stream distributions}
\hlcom{# level 1 = coarse scale (step="gamma", angle="vm")}
\hlcom{# level 2 = fine scale (vertical="gamma")}
...
Nevertheless, we can see that the estimated stationary probabilities as a function of time of day are very similar (Figure \ref{fig:codStat}).
\begin{figure}[htbp]
  \centering
