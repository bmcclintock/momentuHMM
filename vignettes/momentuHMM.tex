...
\hlkwd{proj4string}\hlstd{(boundary)} \hlkwb{<-} \hlstd{sp}\hlopt{::}\hlkwd{CRS}\hlstd{(}\hlstr{"+init=epsg:6328"}\hlstd{)}
...
\hlstd{DM} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{mu}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{mean.x}\hlstd{=}\hlopt{~}\hlstd{mu.x_tm1}\hlopt{+}\hlkwd{crw}\hlstd{(mu.x_tm1,}\hlkwc{lag}\hlstd{=}\hlnum{1}\hlstd{)}\hlopt{+}\hlstd{grad.x,}
                   ...
                   \hlkwc{sd.x}\hlstd{=}\hlopt{~}\hlnum{1}\hlstd{,}
                   \hlkwc{sd.y}\hlstd{=}\hlopt{~}\hlnum{1}\hlstd{,}
                   \hlkwc{corr.xy}\hlstd{=}\hlopt{~}\hlnum{1}\hlstd{))}

\hlcom{# specify parameters on working parameter scale}
\hlstd{Par} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{mu}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{0.75}\hlstd{,}\hlopt{-}\hlnum{1500}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{0.75}\hlstd{,}\hlopt{-}\hlnum{1500}\hlstd{,}\hlkwd{log}\hlstd{(}\hlkwd{sqrt}\hlstd{(}\hlnum{100000}\hlstd{)),}\hlkwd{log}\hlstd{(}\hlkwd{sqrt}\hlstd{(}\hlnum{100000}\hlstd{)),}\hlnum{0}\hlstd{))}
\hlkwd{names}\hlstd{(Par}\hlopt{$}\hlstd{mu)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"mu.x_tm1"}\hlstd{,}\hlstr{"crw(mu.x_tm1,lag=1)"}\hlstd{,}\hlstr{"grad.x"}\hlstd{,}
                   ...
                   \hlstr{"sd.x"}\hlstd{,}\hlstr{"sd.y"}\hlstd{,}\hlstr{"corr.xy"}\hlstd{)}
...
\hlstd{DM} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{mu}\hlstd{=}\hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"mu.x_tm1"}\hlstd{,}\hlstr{"langevin(bathy.x)"}\hlstd{,}\hlstr{"langevin(slope.x)"}\hlstd{,}
                     ...
                     \hlkwd{c}\hlstd{(}\hlstr{"mean:mu_tm1"}\hlstd{,}\hlstr{"bathy"}\hlstd{,}\hlstr{"slope"}\hlstd{,}\hlstr{"d2site"}\hlstd{,}
                       \hlstr{"sd:(Intercept)"}\hlstd{,}\hlstr{"corr.xy:(Intercept)"}\hlstd{))))}
\hlstd{DM}\hlopt{$}\hlstd{mu}
\end{alltt}
\begin{verbatim}
