...
\textbf{2.} Here we provide a guide to using an open-source R package, \verb|momentuHMM| version 1.4.2%(Maximum likelihood analysis Of animal MovemENT behavior Using multivariate Hidden Markov Models)
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{prior} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{par}\hlstd{) \{}\hlkwd{sum}\hlstd{(}\hlkwd{dnorm}\hlstd{(par[}\hlnum{27}\hlopt{+}\hlnum{1}\hlopt{:}\hlnum{90}\hlstd{],}\hlnum{0}\hlstd{,}\hlnum{100}\hlstd{,}\hlkwc{log}\hlstd{=}\hlnum{TRUE}\hlstd{))\}}
...
## 1 0.2931197 0.1762488 0.1687088 0.05937795  0.128181 0.1743638
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## 1      1 0.38493724 0.13807531 0.21757322 0.09205021 0.06694561 0.10041841
## 2      2 0.22435897 0.14102564 0.27564103 0.10256410 0.17307692 0.08333333
## 3      3 0.07843137 0.26960784 0.35294118 0.05882353 0.04411765 0.19607843
## 4      4 0.39215686 0.20915033 0.00000000 0.03921569 0.15686275 0.20261438
## 5      5 0.81967213 0.01639344 0.00000000 0.00000000 0.07377049 0.09016393
## 6      6 0.04278075 0.22994652 0.06417112 0.03743316 0.27272727 0.35294118
\end{verbatim}
\end{kframe}
\end{knitrout}
