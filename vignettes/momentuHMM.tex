...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{URL} \hlkwb{<-} \hlkwd{paste0}\hldef{(}\hlsng{"https://www.datarepository.movebank.org/bitstream/handle/"}\hldef{,}
              \hlsng{"10255/move.373/Elliptical%20Time-Density%20Model%20%28Wall%"}\hldef{,}
              \hlsng{"20et%20al.%202014%29%20African%20Elephant%20Dataset%20%"}\hldef{,}
              \hlsng{"28Source-Save%20the%20Elephants%29.csv"}\hldef{)}
\hldef{rawData} \hlkwb{<-} \hlkwd{read.csv}\hldef{(}\hlkwd{url}\hldef{(URL))}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in open.connection(file, "{}rt"{}): URL 'https://datarepository.movebank.org/bitstream/handle/10255/move.373/Elliptical\%20Time-Density\%20Model\%20(Wall\%20et\%20al.\%202014)\%20African\%20Elephant\%20Dataset\%20(Source-Save\%20the\%20Elephants).csv': Timeout of 60 seconds was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(file, "{}rt"{}): cannot open the connection to 'https://www.datarepository.movebank.org/bitstream/handle/10255/move.373/Elliptical\%20Time-Density\%20Model\%20\%28Wall\%20et\%20al.\%202014\%29\%20African\%20Elephant\%20Dataset\%20\%28Source-Save\%20the\%20Elephants\%29.csv'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# [ ---------------------------------------------------------------------------------------------------- ] 0\%[ ====------------------------------------------------------------------------------------------------ ] 4\%[ =======--------------------------------------------------------------------------------------------- ] 7\%[ ===========----------------------------------------------------------------------------------------- ] 11\%[ ==============-------------------------------------------------------------------------------------- ] 14\%[ ==================---------------------------------------------------------------------------------- ] 18\%[ ======================------------------------------------------------------------------------------ ] 22\%[ ==========================-------------------------------------------------------------------------- ] 26\%[ ==============================---------------------------------------------------------------------- ] 30\%[ =================================------------------------------------------------------------------- ] 33\%[ ===================================----------------------------------------------------------------- ] 35\%[ =====================================--------------------------------------------------------------- ] 37\%[ ========================================------------------------------------------------------------ ] 40\%[ ============================================-------------------------------------------------------- ] 44\%[ ================================================---------------------------------------------------- ] 48\%[ ===================================================------------------------------------------------- ] 51\%[ ======================================================---------------------------------------------- ] 54\%[ =======================================================--------------------------------------------- ] 55\%[ =======================================================--------------------------------------------- ] 55\%[ ==========================================================------------------------------------------ ] 58\%[ =============================================================--------------------------------------- ] 61\%[ =================================================================----------------------------------- ] 65\%[ =====================================================================------------------------------- ] 69\%[ =========================================================================--------------------------- ] 73\%[ =============================================================================----------------------- ] 77\%[ ================================================================================-------------------- ] 80\%[ ====================================================================================---------------- ] 84\%[ ========================================================================================------------ ] 88\%[ ============================================================================================-------- ] 92\%[ ================================================================================================---- ] 96\%[ ==================================================================================================== ] 100\%}}\end{kframe}
\end{knitrout}
...
## $nonforaging
##       nf1       nf2       nf3 
## 0.2793769 0.5060947 0.2145284 
## 
## $foraging
##         f1         f2         f3 
## 0.08308649 0.11164262 0.80527089
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## [1,]           1 0.1344924 0.07609366 -0.02060422       1.257144
##      corr.xy:(Intercept)
## [1,]                   0
## 
...
## $se
##      mean:mu_tm1     bathy     slope      d2site sd:(Intercept)
## [1,]           0 0.0704616 0.1273185 0.005160587    0.009679295
##      corr.xy:(Intercept)
## [1,]                   0
## 
## $lower
##      mean:mu_tm1        bathy     slope      d2site sd:(Intercept)
## [1,]           1 -0.003609856 -0.173446 -0.03071879       1.238173
##      corr.xy:(Intercept)
## [1,]                   0
## 
## $upper
##      mean:mu_tm1     bathy     slope      d2site sd:(Intercept)
## [1,]           1 0.2725946 0.3256334 -0.01048965       1.276115
##      corr.xy:(Intercept)
## [1,]                   0
\end{verbatim}
\end{kframe}
