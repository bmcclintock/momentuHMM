...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in load(url(paste0("{}https://static-content.springer.com/esm/"{}, "{}art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/"{}, : URL 'https://static-content.springer.com/esm/art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/13253\_2017\_282\_MOESM1\_ESM.rdata': status was 'Peer certificate cannot be authenticated with given CA certificates'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in load(url(paste0("{}https://static-content.springer.com/esm/"{}, "{}art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/"{}, : cannot open the connection to 'https://static-content.springer.com/esm/art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/13253\_2017\_282\_MOESM1\_ESM.rdata'}}\begin{alltt}
\hlstd{W} \hlkwb{<-} \hlkwd{dim}\hlstd{(dataAr)[}\hlnum{3}\hlstd{]} \hlcom{# number of individuals}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'dataAr' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'W' not found}}\begin{alltt}
\hlcom{# prepare hierarchical data}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prepData.default(snakeData, coordNames = NULL, hierLevels = c("{}1"{}, : data must be a data frame}}\begin{alltt}
\hlcom{# summarize prepared data}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'raster' was built under R version 4.0.5}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
## sigma.xy "0"         "0"                 "0"                
## sigma.y  "0"         "0"                 "0"                
##          d2site               sigma:(Intercept) sigma.xy:(Intercept)
...
## Regression coeffs for mu parameters:
## ------------------------------------
##      mean:mu_tm1     bathy      slope     d2site sigma:(Intercept)
## [1,]           1 0.1344957 0.07609687 -0.0206041          2.514288
##      sigma.xy:(Intercept)
## [1,]                    0
## 
...
## $se
##      mean:mu_tm1      bathy     slope      d2site sigma:(Intercept)
## [1,]           0 0.07045873 0.1273107 0.005160585        0.01935859
##      sigma.xy:(Intercept)
## [1,]                    0
## 
## $lower
##      mean:mu_tm1        bathy      slope      d2site sigma:(Intercept)
## [1,]           1 -0.003600898 -0.1734276 -0.03071866          2.476345
##      sigma.xy:(Intercept)
## [1,]                    0
## 
## $upper
##      mean:mu_tm1     bathy     slope      d2site sigma:(Intercept)
## [1,]           1 0.2725923 0.3256213 -0.01048954           2.55223
##      sigma.xy:(Intercept)
## [1,]                    0
\end{verbatim}
\end{kframe}
