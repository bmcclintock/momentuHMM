...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prepData(porpoiseData, coordNames = NULL, hierLevels = c("{}1"{}, : could not find function "{}prepData"{}}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{hierStates} \hlkwb{<-} \hlkwd{as.Node}\hlstd{(}\hlkwd{list}\hlstd{(}\hlkwc{name}\hlstd{=}\hlstr{"harbor porpoise HHMM states"}\hlstd{,}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in getParDM(porpoiseData, hierStates = hierStates, hierDist = hierDist, : could not find function "{}getParDM"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in checkPar0(porpoiseData, hierStates = hierStates, hierDist = hierDist, : could not find function "{}checkPar0"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in viterbi(hhmm): could not find function "{}viterbi"{}}}\begin{alltt}
\hlkwd{length}\hlstd{(states)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'states' not found}}\begin{alltt}
\hlkwd{head}\hlstd{(states)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(states): object 'states' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in viterbi(hhmm, hierarchical = TRUE): could not find function "{}viterbi"{}}}\begin{alltt}
\hlkwd{lapply}\hlstd{(hStates,length)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(hStates, length): object 'hStates' not found}}\begin{alltt}
\hlkwd{head}\hlstd{(hStates}\hlopt{$}\hlstd{level1)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(hStates\$level1): object 'hStates' not found}}\begin{alltt}
\hlkwd{head}\hlstd{(hStates}\hlopt{$}\hlstd{level2)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(hStates\$level2): object 'hStates' not found}}\end{kframe}
\end{knitrout}

We can also plot the estimated state probabilities for each level of the hierarchy (Figures \ref{fig:hpLevel1} and \ref{fig:hpLevel2}) using the \verb|plotStates| function:
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\hlstd{simHHMM} \hlkwb{<-} \hlkwd{simHierData}\hlstd{(}\hlkwc{model}\hlstd{=hhmm,} \hlkwc{obsPerLevel} \hlstd{= obsPerLevel,} \hlkwc{states} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in simHierData(model = hhmm, obsPerLevel = obsPerLevel, states = TRUE): could not find function "{}simHierData"{}}}\begin{alltt}
\hlkwd{head}\hlstd{(simHHMM)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(simHHMM): object 'simHHMM' not found}}\end{kframe}
\end{knitrout}
