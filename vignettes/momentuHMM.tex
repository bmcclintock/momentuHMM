...
\textbf{2.} Here we provide a guide to using an open-source R package, \verb|momentuHMM| version 1.4.3%(Maximum likelihood analysis Of animal MovemENT behavior Using multivariate Hidden Markov Models)
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
DM$angle = \hlkwd{list}(mean = ~\hlkwd{state2}(\hlkwd{angleFormula}(d, strength = w)), 
                concentration= ~1))
\end{alltt}
\end{kframe}
\end{knitrout}
