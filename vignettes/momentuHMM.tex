...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in !m\$conditions\$fit: invalid argument type}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Par0\_mix3\$beta\$beta[1, ] <- c(-2.15, -4.31, -1.09, 0.28, -1.88, : object 'Par0\_mix3' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Par0\_mix3\$beta\$beta[2, ] <- c(-2.5, -2.47, 0.63, -17.22, -13.18, : object 'Par0\_mix3' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Par0\_mix3\$beta\$beta[3, ] <- c(-2.71, -3.48, -3.01, -0.35, -1.12, : object 'Par0\_mix3' not found}}\begin{alltt}
\hlstd{Par0_mix3}\hlopt{$}\hlstd{beta}\hlopt{$}\hlstd{pi} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{0.4}\hlstd{,} \hlnum{0.4}\hlstd{,} \hlnum{0.2}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Par0\_mix3\$beta\$pi <- c(0.4, 0.4, 0.2): object 'Par0\_mix3' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in !m\$conditions\$fit: invalid argument type}}\end{kframe}
\end{knitrout}
