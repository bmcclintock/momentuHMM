...
\begin{alltt}
\hlcom{# fit hierarchical HMM}
hhmm <- \hlkwd{fitHMM}(snakeData,hierStates=hierStates,hierDist=hierDist,
...
## mean 0.12148244 0.6778585 1.3749445 0.12148244 0.6778585 1.3749445
## sd   0.05906919 0.3217371 0.4876126 0.05906919 0.3217371 0.4876126
##             mo3       ex3       es3
## mean 0.12148244 0.6778585 1.3749445
## sd   0.05906919 0.3217371 0.4876126
## 
## 
## ---------------------------------------------------------------
## Regression coeffs for the transition probabilities:
...
## --------------------------  level2  ---------------------------
##                          1 -> 2    1 -> 3   2 -> 2   2 -> 3   3 -> 2
## I((level == "2") * 1) -2.993163 -5.064874 3.927789 1.246248 34.83412
##                         3 -> 3
## I((level == "2") * 1) 35.96589
## 
##                         4 -> 5    4 -> 6   5 -> 5   5 -> 6   6 -> 5
## I((level == "2") * 1) -1.72118 -2.775672 3.540744 2.834411 34.70869
##                         6 -> 6
## I((level == "2") * 1) 36.19201
## 
##                          7 -> 8    7 -> 9   8 -> 8  8 -> 9   9 -> 8
## I((level == "2") * 1) -5.098038 -17.69051 5.761082 -11.341 33.38975
##                         9 -> 9
## I((level == "2") * 1) 37.36931
## 
## ---------------------------------------------------------------
## 
## ---------------------------------------------------------------
