...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in load(url(paste0("{}https://static-content.springer.com/esm/"{}, "{}art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/"{}, : embedded nul in string: '2015-11-13 13:50:5\textbackslash{}0'}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in x\$date\_time: \$ operator is invalid for atomic vectors}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prepData.default(data = porpoiseData, coordNames = NULL, hierLevels = c("{}1"{}, : data must be a data frame}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prepData.default(data = porpoiseData, coordNames = NULL, hierLevels = c("{}1"{}, : data must be a data frame}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in str\_sub(nms, 1, 1): could not find function "{}str\_sub"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in round(x\$gamma[, , 1], 3): non-numeric argument to mathematical function}}\begin{alltt}
\hlcom{# stationary distribution}
