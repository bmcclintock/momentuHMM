...
\textbf{2.} Here we provide a guide to using an open-source R package, \verb|momentuHMM| version 1.5.7%(Maximum likelihood analysis Of animal MovemENT behavior Using multivariate Hidden Markov Models)
...
\hldef{D_scaled} \hlkwb{<-} \hldef{ctmcmove}\hlopt{::}\hlkwd{rast.grad}\hldef{(dist2sabie_scaled)}
...
\hldef{spatialCovs} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{W_intercept} \hldef{= W_ortho}\hlopt{$}\hldef{svd1,}
                    ...
                    \hlkwc{D.x} \hldef{= D_scaled}\hlopt{$}\hldef{rast.grad.x,}
                    \hlkwc{D.y} \hldef{= D_scaled}\hlopt{$}\hldef{rast.grad.y)}
...
## 1  1 313344.4 384560.8 -2770752 -0.0001873081 -0.003616337   1323.424 -1.229027
## 2  1 313344.7 384560.3 -2770751 -0.0001873081 -0.003616337   1323.424 -1.229027
## 3  1 313344.9 384559.8 -2770749 -0.0001873081 -0.003616337   1323.424 -1.229027
## 4  1 313345.2 384559.3 -2770747 -0.0001873081 -0.003616337   1323.424 -1.229027
## 5  1 313345.4 384559.1 -2770744 -0.0001873081 -0.003616337   1323.424 -1.229027
## 6  1 313345.7 384559.1 -2770742 -0.0001873081 -0.003616337   1323.424 -1.229027
##         D.y
## 1 0.3635682
## 2 0.3635682
## 3 0.3635682
...
\hldef{DM} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{mu}\hldef{=}\hlkwd{matrix}\hldef{(}\hlkwd{c}\hldef{(}\hlsng{"mu.x_tm1"}\hldef{,}         \hlnum{0}\hldef{,}    \hlnum{0}\hldef{,}\hlnum{0}\hldef{,}\hlnum{0}\hldef{,}\hlnum{0}\hldef{,}
                     ...
                     \hlkwc{dimnames}\hldef{=}\hlkwd{list}\hldef{(}\hlkwd{c}\hldef{(}\hlkwd{paste0}\hldef{(}\hlsng{"mean."}\hldef{,}
                                            \hlkwd{rep}\hldef{(}\hlkwd{c}\hldef{(}\hlsng{"x_"}\hldef{,}\hlsng{"y_"}\hldef{),}
                                                \hlkwc{each}\hldef{=nbStates),}
                                            \hlnum{1}\hlopt{:}\hldef{nbStates),}
                                     \hlkwd{paste0}\hldef{(}\hlsng{"sigma."}\hldef{,}
                                            \hlkwd{rep}\hldef{(}\hlkwd{c}\hldef{(}\hlsng{"x_"}\hldef{,}\hlsng{"xy_"}\hldef{,}\hlsng{"y_"}\hldef{),}
                                                \hlkwc{each}\hldef{=nbStates),}
                                            \hlnum{1}\hlopt{:}\hldef{nbStates)),}
                                   \hlkwd{c}\hldef{(}\hlsng{"x:x_tm1"}\hldef{,}
                                     \hlsng{"y:y_tm1"}\hldef{,}
                                     \hlsng{"xy:D"}\hldef{,}
                                     \hlsng{"sigma_1:(Intercept)"}\hldef{,}
                                     \hlsng{"sigma_2:(Intercept)"}\hldef{,}
                                     \hlsng{"sigma_12:(Intercept)"}\hldef{))))}

\hlcom{# starting values}
\hldef{Par0}\hlkwb{=}\hlkwd{list}\hldef{(}\hlkwc{mu}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{1}\hldef{,} \hlnum{1}\hldef{,} \hlnum{0}\hldef{,} \hlkwd{log}\hldef{(}\hlnum{85872.66}\hldef{),} \hlkwd{log}\hldef{(}\hlnum{37753.53}\hldef{),} \hlnum{0}\hldef{))}
...
\hlkwd{plot}\hldef{(trProbs}\hlopt{$}\hldef{est[}\hlnum{1}\hldef{,}\hlnum{2}\hldef{,],}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{,} \hlkwc{ylim}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{0}\hldef{,}\hlnum{1}\hldef{),}
     \hlkwc{ylab}\hldef{=}\hlsng{"Pr(discharged)"}\hldef{,} \hlkwc{xlab}\hldef{=}\hlsng{"t"}\hldef{,}
...
\hlkwd{proj4string}\hldef{(boundary)} \hlkwb{<-} \hldef{sp}\hlopt{::}\hlkwd{CRS}\hldef{(}\hlsng{"+init=epsg:4326"}\hldef{)}

\hlcom{# compute gradients in x- and y- directions}
\hldef{grad} \hlkwb{<-} \hldef{ctmcmove}\hlopt{::}\hlkwd{rast.grad}\hldef{(boundary)}
\hldef{grad.x} \hlkwb{<-} \hldef{grad}\hlopt{$}\hldef{rast.grad.x}
\hldef{grad.y} \hlkwb{<-} \hldef{grad}\hlopt{$}\hldef{rast.grad.y}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{alltt}
\hldef{dist} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{mu}\hldef{=}\hlsng{"rw_mvnorm2"}\hldef{)} \hlcom{# bivariate normal random walk}
\hldef{DM} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{mu}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{mean.x}\hldef{=}\hlopt{~}\hldef{mu.x_tm1}\hlopt{+}\hlkwd{crw}\hldef{(mu.x_tm1,}\hlkwc{lag}\hldef{=}\hlnum{1}\hldef{)}\hlopt{+}\hldef{grad.x,}
                   \hlkwc{mean.y}\hldef{=}\hlopt{~}\hldef{mu.y_tm1}\hlopt{+}\hlkwd{crw}\hldef{(mu.y_tm1,}\hlkwc{lag}\hldef{=}\hlnum{1}\hldef{)}\hlopt{+}\hldef{grad.y,}
                   \hlkwc{sigma.x}\hldef{=}\hlopt{~}\hlnum{1}\hldef{,}
                   \hlkwc{sigma.xy}\hldef{=}\hlopt{~}\hlnum{1}\hldef{,}
                   \hlkwc{sigma.y}\hldef{=}\hlopt{~}\hlnum{1}\hldef{))}

\hlcom{# specify parameters on working parameter scale}
\hldef{Par} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{mu}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{1}\hldef{,}\hlnum{0.75}\hldef{,}\hlopt{-}\hlnum{750000}\hldef{,}\hlnum{1}\hldef{,}\hlnum{0.75}\hldef{,}\hlopt{-}\hlnum{1500}\hldef{,}\hlkwd{log}\hldef{(}\hlnum{100000}\hldef{),}\hlnum{0}\hldef{,}\hlkwd{log}\hldef{(}\hlnum{100000}\hldef{)))}
\hlkwd{names}\hldef{(Par}\hlopt{$}\hldef{mu)} \hlkwb{<-} \hlkwd{c}\hldef{(}\hlsng{"mu.x_tm1"}\hldef{,}\hlsng{"crw(mu.x_tm1,lag=1)"}\hldef{,}\hlsng{"grad.x"}\hldef{,}
                   \hlsng{"mu.y_tm1"}\hldef{,}\hlsng{"crw(mu.y_tm1,lag=1)"}\hldef{,}\hlsng{"grad.y"}\hldef{,}
                   \hlsng{"sigma.x"}\hldef{,}\hlsng{"sigma.xy"}\hldef{,}\hlsng{"sigma.y"}\hldef{)}
...
\hldef{simBound} \hlkwb{<-} \hlkwd{simData}\hldef{(}\hlkwc{nbStates}\hldef{=}\hlnum{1}\hldef{,} \hlkwc{obsPerAnimal} \hldef{=} \hlnum{10000}\hldef{,} \hlkwc{dist}\hldef{=dist,} \hlkwc{Par}\hldef{=Par,}
                    \hlkwc{DM}\hldef{=DM,} \hlkwc{spatialCovs}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{grad.x} \hldef{= grad.x,}
                                            \hlkwc{grad.y} \hldef{= grad.y),}
...
\hlkwd{plot}\hldef{(boundary}\hlopt{$}\hldef{boundary)}
