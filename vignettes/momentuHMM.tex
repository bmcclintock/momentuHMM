...
\textbf{2.} Here we provide a guide to using an open-source R package, \verb|momentuHMM| version 1.5.1%(Maximum likelihood analysis Of animal MovemENT behavior Using multivariate Hidden Markov Models)
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in load(url(paste0("{}https://static-content.springer.com/esm/"{}, "{}art\%3A10.1007\%2Fs13253-017-0282-9/MediaObjects/"{}, : ReadItem: unknown type 0, perhaps written by later version of R}}\begin{alltt}
