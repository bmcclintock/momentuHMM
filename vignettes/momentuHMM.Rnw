...
# initial parameters
nPar0_m1 <- list(step=c(100,500,100,200),angle=c(0.3,0.7))

# fit model
m1 <- fitHMM(data = data, nbStates = 2, dist = dist, Par0 = nPar0_m1, 
...
nPar0_m2 <- getPar0(model=m1, formula=formula)

# fit model
m2 <- fitHMM(data = data, nbStates = 2, dist = dist, Par0 = nPar0_m2$Par, 
             beta0=nPar0_m2$beta, stateNames = stateNames, formula=formula)
@ 
...
nPar0_m3 <- getPar0(model=m2, formula=formula, DM=DM)

# fit model
m3 <- fitHMM(data = data, nbStates = 2, dist = dist, Par0 = nPar0_m3$Par, 
             beta0 = nPar0_m3$beta, DM = DM, stateNames = stateNames,
             formula = formula)
@ 
