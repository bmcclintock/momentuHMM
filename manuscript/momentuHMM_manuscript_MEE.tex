...
\textbf{2.} Here we introduce an open-source R package, \verb|momentuHMM|%version 1.2.1 (Maximum likelihood analysis Of animal MovemENT behaviour Using multivariate Hidden Markov Models)
