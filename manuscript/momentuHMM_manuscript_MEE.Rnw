...
To address these defeciencies in existing software, we introduce a new user-friendly R package, \verb|momentuHMM|% (Maximum likelihood analysis Of animal MovemENT behaviour Using multivariate Hidden Markov Models)
