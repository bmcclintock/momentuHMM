...
\textbf{2.} Here we introduce a user-friendly R package, \verb|momentuHMM| version 1.1.1%(Maximum likelihood analysis Of animal MovemENT behavior Using multivariate Hidden Markov Models)
